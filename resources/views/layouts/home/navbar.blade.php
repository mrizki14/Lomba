<!-- *NAVBAR* -->
<header>
    <nav class="navbar navbar-expand-lg bg-transparent navbar-expand-xl fixed-top py-3">
      <div class="container-fluid px-5">
        ...
        <div class="hamburger-menu">
          ...
          <label class="menu__btn" for="menu__toggle">
              <span></span>
                    ...
                    <li class="menu__item">
                      <a class="nav-link-1 mx-3 {{ request()->is('penyakits') ? 'active-1' : '' }}" href="/penyakit">Penyakit</a>
                    </li>
                    <li class="menu__item">
        ...
        <div class="navbar-links">
          <ul class="top-menu navbar-nav ms-auto">
            ...
            @endguest
            @auth
            <li><a class="nav-link-1 mx-3 login-1" href="/dashboard">Dashboard</a></li>
            @endauth

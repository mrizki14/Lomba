<!-- *NAVBAR* -->
<nav class="navbar navbar-expand-md navbar-expand-lg navbar-expand-xl py-3 bg-transparent bg-transparent-2 fixed-top">
    <div class="container-fluid px-5">
      ...
      <div class="hamburger-menu">
          ...
          <label class="menu__btn" for="menu__toggle">
              <span></span>
                    ...
                    <li class="menu__item"><a class="nav-link-1 mx-3 {{ Request::is('/') ? 'active' : '' }} " aria-current="page" href="/">Beranda</a></li>
      ...
      <div class="navbar-links">
        <ul class="top-menu navbar-nav ms-auto">
            <li><a class="nav-link-2 mx-3 {{ Request::is('/') ? 'active' : '' }} " aria-current="page" href="/">Beranda</a></li>
            <li><a class="nav-link-2 mx-3 {{ Request::is('rumahsakit') ? 'active' : '' }} " href="/rumahsakit">Rumah Sakit</a></li>
            <li><a class="nav-link-2 mx-3 {{ Request::is('penyakit') ? 'active' : '' }}" href="{{ url ('/penyakit') }}">Penyakit</a></li>
            <li><a class="nav-link-2 mx-3 {{ Request::is('tentang') ? 'active' : '' }}" href="{{ url ('/tentang') }}">Tentang</a></li>
            <li>
            @guest            
            <a class="nav-link-2 mx-3 login-2" href="{{ url ('/login') }}">Masuk <img src="{{ asset('assets/image/icon/icon-login.svg')}}" alt="icon-login" /></a>
            @endguest
          </li>
          @auth
